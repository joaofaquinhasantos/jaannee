...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover and compare Thailand's best dishes. Diners compare dishes head-to-head to surface the best Pad Kra Pao, Khao Soi, and Boat Noodles in Bangkok." },
      { name: "author", content: "JaanNee" },
      { property: "og:title", content: "JaanNee — Rank the dish, not the restaurant" },
      { property: "og:description", content: "Diners compare dishes head-to-head to rank the best plates in Bangkok, dish by dish." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "JaanNee — Rank the dish, not the restaurant" },
      { name: "twitter:description", content: "Diners compare dishes head-to-head to rank the best plates in Bangkok, dish by dish." },
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            ...
            },
            {
              ...
              description:
                "Diners compare Thailand's best dishes head-to-head, dish by dish.",
            },
          ],
        }),
      },
