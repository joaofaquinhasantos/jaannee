  ...
  head: () => ({
    meta: [
      { title: "Dish rankings — JaanNee" },
      {
        name: "description",
        content:
          "Live rankings for Thailand's best dishes, based on head-to-head comparisons from local diners across Bangkok categories and areas.",
      },
      { property: "og:title", content: "Dish rankings — JaanNee" },
      {
        property: "og:description",
        content:
          "Live rankings for Thailand's best dishes, based on head-to-head comparisons from local diners.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Dish rankings",
          description:
            "Live rankings for Thailand's best dishes, based on head-to-head diner comparisons.",
...
function Rankings() {
  ...
  const board = useQuery({
    ...
    queryFn: () =>
      leaderboard({
        data: { categorySlug: cat!, subtypeSlug: subtype, areaSlug: area, minimumComparisons: 5 },
      }),
    enabled: poolReady,
  });
  ...
  return (
    <AppShell>
      <section className="pb-6 pt-5 md:pb-8 md:pt-10">
        <h1 className="type-page-title">{t("nav_rankings")}</h1>
      </section>
